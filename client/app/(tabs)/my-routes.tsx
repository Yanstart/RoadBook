    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity style={styles.addButton}>
                <MaterialIcons name="add-box" size={40} color={colors.primary} onPress={() => setModalVisible(true)} />
            </TouchableOpacity>
            <TouchableOpacity style={styles.printButton}>
                <Ionicons name="print-outline" size={40} color={colors.primary} onPress={() => router.push('/(tabs)/')} />
            </TouchableOpacity>
        </View>
    );
}
