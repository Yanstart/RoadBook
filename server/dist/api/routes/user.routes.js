 ...
 * @access  Private - Requires authentication
 */
router.put("/me", auth_middleware_1.authenticate, userController.updateCurrentUser);
/**
 * @route   PUT /api/users/me/password
 * @desc    Change current user password
 * @access  Private - Requires authentication
 */
router.put("/me/password", auth_middleware_1.authenticate, validation_middleware_1.validateChangePassword, userController.changePassword);
/**
 * @route   POST /api/users/me/profile-picture
 * @desc    Upload or update current user's profile picture
 * @access  Private - Requires authentication
 */
router.post("/me/profile-picture", auth_middleware_1.authenticate, validation_middleware_1.validateProfilePicture, userController.uploadProfilePicture);
/**
 * @route   DELETE /api/users/me/profile-picture
 * @desc    Delete current user's profile picture
 * @access  Private - Requires authentication
 */
router.delete("/me/profile-picture", auth_middleware_1.authenticate, userController.deleteProfilePicture);
 ...
 * @access  Admin only
 */
router.get("/", auth_middleware_1.authenticate, (0, auth_middleware_1.authorizeRoles)("ADMIN"), userController.getAllUsers);
 ...
 */
router.get("/:id/competencies/stats", auth_middleware_1.authenticate, competencyController.getApprenticeCompetencyStats);
