...
export const roadbookService = createCrudService('roadBook', {
...
export const sessionService = createCrudService('session', {
  // Relations to include
  includeRelations: {
    apprentice: {
      select: {
...
// Competency service
export const competencyService = createCrudService('competency', {
...
export const competencyProgressService = createCrudService('competencyProgress', {
  // Relations to include
  includeRelations: {
    competency: true,
    roadbook: {
...
// Post service
export const postService = createCrudService('post', {
  // Relations to include
  includeRelations: {
    author: {
      select: {
...
// Comment service
export const commentService = createCrudService('comment', {
  // Relations to include
  includeRelations: {
    author: {
      select: {
...
// Badge service
export const badgeService = createCrudService('badge', {
...
// UserBadge service
export const userBadgeService = createCrudService('userBadge', {
  // Relations to include
  includeRelations: {
    user: {
      select: {
