-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('APPRENTICE', 'GUIDE', 'INSTRUCTOR', 'ADMIN');

-- CreateEnum
CREATE TYPE "RoadBookStatus" AS ENUM ('ACTIVE', 'COMPLETED', 'ARCHIVED');

-- CreateEnum
CREATE TYPE "WeatherCondition" AS ENUM ('CLEAR', 'CLOUDY', 'RAINY', 'SNOWY', 'FOGGY', 'WINDY', 'OTHER');

-- CreateEnum
CREATE TYPE "DaylightCondition" AS ENUM ('DAY', 'NIGHT', 'DAWN_DUSK');
...
CREATE TABLE "RoadBook" (
    ...
    "title" TEXT NOT NULL,
    "description" TEXT,
    "status" "RoadBookStatus" NOT NULL DEFAULT 'ACTIVE',
    "targetHours" INTEGER NOT NULL DEFAULT 30,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "apprenticeId" TEXT NOT NULL,
    "guideId" TEXT,
    "lastExportDate" TIMESTAMP(3),
    "lastSignatureDate" TIMESTAMP(3),
...
-- AddForeignKey
ALTER TABLE "RoadBook" ADD CONSTRAINT "RoadBook_apprenticeId_fkey" FOREIGN KEY ("apprenticeId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RoadBook" ADD CONSTRAINT "RoadBook_guideId_fkey" FOREIGN KEY ("guideId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Session" ADD CONSTRAINT "Session_roadbookId_fkey" FOREIGN KEY ("roadbookId") REFERENCES "RoadBook"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Session" ADD CONSTRAINT "Session_apprenticeId_fkey" FOREIGN KEY ("apprenticeId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Session" ADD CONSTRAINT "Session_validatorId_fkey" FOREIGN KEY ("validatorId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
